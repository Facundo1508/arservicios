...
class UsuariosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'nombre_usuario' => ['type' => 'string', 'length' => 20, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'contraseña' => ['type' => 'string', 'length' => 10, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_indexes' => [
            'rol_id' => ['type' => 'index', 'columns' => ['rol_id', 'genero_id'], 'length' => []],
        ],
        '_constraints' => [
    ...
    public $records = [
        [
            'id' => '9cfb71be-8bfa-4d63-9b33-a78362bd6f8a',
            ...
            'contraseña' => 'Lorem ip',
            'activo' => 1,
            'rol_id' => '7d5840ce-a1e5-4326-a715-10c40a6c680e',
            'genero_id' => 'd10a0168-393a-445c-ba35-f3f5988ad20a',
            'created' => 1509649594,
            'modified' => 1509649594
        ],
    ];
